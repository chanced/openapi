...
type cache struct {
	...
	ResolvedHeaders         map[*Header]*ResolvedHeader
	ResolvedRequestBodies   map[*RequestBodyObj]*ResolvedRequestBody
	ResolvedCallbacks       map[*Callback]*ResolvedCallback
	...
	ResolvedSchemas         map[*Schema]*ResolvedSchema
}
...
func newCache() *cache {
	return &cache{
		...
		ResolvedHeaders:         make(map[*Header]*ResolvedHeader),
		ResolvedRequestBodies:   make(map[*RequestBodyObj]*ResolvedRequestBody),
		ResolvedCallbacks:       make(map[*Callback]*ResolvedCallback),
		...
		ResolvedSchemas:         make(map[*Schema]*ResolvedSchema),
	}
}
