...
func (sso *SecuritySchemeObj) ResolveSecurityScheme(SecuritySchemeResolverFunc) (*SecuritySchemeObj, error) {
	return sso, nil
}

// SecurityScheme can either be a ScecuritySchemeObj or a Reference
type SecurityScheme interface {
	ResolveSecurityScheme(SecuritySchemeResolverFunc) (*SecuritySchemeObj, error)
